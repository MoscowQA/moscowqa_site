...
- title: Zero to Hero. Production QA
  ...
  date: '2024-04-22'
  url: https://heisenbug.ru/archive/2024%20Spring/talks/a93ec73eedbf407b84b29d99647c7c57/
  slides_url: https://squidex.jugru.team/api/assets/srm/1f1edb35-5c07-4e51-a355-8fd0fe0480b6/heisenbug-spring-2024-1-.pdf
- title: 'QA revolution: cовременные подходы и технологии в embedded-тестировании'
...
15+ лет инженерного опыта: от highload-систем до устройств для взлома. Помогаю компаниям внедрять AI-агентов, держать их под контролем и честно оценивать эффект. Пытаюсь внести инженерный подход в чайка-менеджмент, и иногда это даже работает.
